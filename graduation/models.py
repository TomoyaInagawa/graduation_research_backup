...
class AddGuideCourse(models.Model):
    ...
    guidecourse = models.ForeignKey(GuideCourse,verbose_name='ガイドコース', on_delete=models.PROTECT, related_name='AddGuideCourse')
...
class Store(models.Model):
    ...
    pic2 = models.ImageField(verbose_name='写真２', blank=True)
    pic3 = models.ImageField(verbose_name='写真３', blank=True)
    pic4 = models.ImageField(verbose_name='写真４', blank=True)
    pic5 = models.ImageField(verbose_name='写真５', blank=True)
